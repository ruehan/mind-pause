...
import type { Route } from "./+types/login_old";
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center h-16">
            ...
            <Link to="/" className="flex items-center ml-8">
              <img src="/logo.png" alt="마음쉼표 로고" className="w-20 h-20 rounded-lg" />
              <span className="ml-3 text-3xl font-bold text-neutral-900 tracking-tight">
                마음쉼표
              </span>
            </Link>
          </div>
